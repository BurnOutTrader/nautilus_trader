...
QUANTITY = 1
SIDE = "BUY"
LIMIT_POINTS_FROM_MARKET = 20.0
STOP_POINTS_FROM_MARKET = 20.0
HOLD_SECONDS = 2.0
...
async def main() -> None:  # noqa: C901
    ...
    limit_points_from_market = float(LIMIT_POINTS_FROM_MARKET)
    stop_points_from_market = float(STOP_POINTS_FROM_MARKET)

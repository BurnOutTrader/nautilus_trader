...
1. Uses a specific configured Rithmic contract
2. Builds a LiveNode with both data and execution clients
3. Subscribes to live 15-second Rithmic bars by default
4. Trades the configured account using cache-backed PyO3 strategy state
...
def main() -> None:
    ...
    print(f"Exec client ID: {exec_client_id}")
    print(f"Account ID: {adapter_account_id}")

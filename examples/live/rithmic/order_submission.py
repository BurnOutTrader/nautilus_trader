...
Example configuration:
    Edit the constants below for instrument ID, quantity, and offsets.
...
MODIFIED_LIMIT_POINTS_BELOW_BID = 10.0
...
async def main() -> None:
    ...
    initial_points_below_bid = float(INITIAL_LIMIT_POINTS_BELOW_BID)
    modified_points_below_bid = float(MODIFIED_LIMIT_POINTS_BELOW_BID)

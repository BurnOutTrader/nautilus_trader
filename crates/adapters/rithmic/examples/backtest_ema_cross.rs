...
//! High-level Rithmic Rust backtest example using catalog bars and a custom bar strategy.
//!
//! Run with:
//! `cargo run --example rithmic-rust-backtest-ema-cross --package rithmic-nt`
//!
...
use crate::support::{
    ...
    common::{
        build_external_bar_type, env_string, example_root_from_env, format_utc_nanos, load_env,
...
fn main() -> anyhow::Result<()> {
    ...
    let run_id = "rithmic-rust-backtest-ema-cross".to_string();

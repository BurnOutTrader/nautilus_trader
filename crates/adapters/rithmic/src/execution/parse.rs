...
#[allow(dead_code)]
pub(crate) fn parse_order_status(status_code: i32) -> Result<OrderStatus> {
    match status_code {
...
#[allow(dead_code)]
pub(crate) fn parse_order_side(side_code: i32) -> Result<OrderSide> {
    match side_code {
        1 => Ok(OrderSide::Buy),
        2 => Ok(OrderSide::Sell),
        _ => Err(RithmicError::Parse(format!(
...
#[allow(dead_code)]
pub(crate) fn parse_order_type(type_code: i32) -> Result<OrderType> {
    match type_code {
...
#[allow(dead_code)]
pub(crate) fn parse_time_in_force(tif_code: i32) -> Result<TimeInForce> {
    match tif_code {
